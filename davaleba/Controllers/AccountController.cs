...
namespace davaleba.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        UserAccountDataProvider dataProvider = new UserAccountDataProvider();
        ProjectDataProvider projectData = new ProjectDataProvider();
        ...
        ////         var user = new ApplicationUser { UserName = model.First_Name, Email = model.Mail };
        ...
        //// {
        ////     if (ModelState.IsValid && dataProvider.ValidLogin(model))
        ////     {
        ////         return RedirectToAction("Index", "Home");
        ////     }
...
//        POST: /Account/VerifyCode
       ...
       [AllowAnonymous]
         public ActionResult Register()
        {
            //var categories = projectData.GetUserCategories().ToList();
